...
import MuDroid.XmlOp.APD;
import MuDroid.XmlOp.BWD;
import MuDroid.XmlOp.TWD;
...
public class DealXmlSaxMutant extends DealXmlSax
{
	...
	{
		run(new DealXmlSaxMutant(), new String[]{"F:/muAndroid/activity-lifecycle/src/activity_a.xml"});
	}
