...
public static void main(String[] args) {
		...
		run(new ReadMutantfromXml(), args);
		//mutantJavaAndXmlList.getInstance().readJavaList();
	}
	public static void main2(String[] args) {
		
		args=new String[]{"F:/muandroid3/AndroidApp-master/app/mutant/main/.projectToXMLs/projectToXMLs_java.xml","WelcomeActivity.java","all","classOp","all","all"};
		run(new ReadMutantfromXml(), args);
		mutantJavaAndXmlList.getInstance().readJavaList();
	}
	...
	protected void process(Document document) throws Exception 
	{
		...
		mutantJavaAndXmlList.getInstance().setJavaList(mutentedJava);
	}
