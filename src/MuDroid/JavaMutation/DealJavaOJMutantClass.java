...
//	try {
//		AndroidMutationSystem.recordInheritanceRelation();
//	} catch (Exception e1) {
//		// TODO Auto-generated catch block
//		e1.printStackTrace();
//	}
//	String root="F:/muandroid3/AndroidApp-master";
//	String	classesDebugPath="/app/build/intermediates/classes/debug";
//	try {
//		addURL(root+classesDebugPath);
//	} catch (Exception e1) {
//		// TODO Auto-generated catch block
//		e1.printStackTrace();
//	}
...
//		e.printStackTrace();
//	}
	//args= new String[]{"F:/muandroid3/zujian2android/app/src/main/java/com/example/administrator/zujian2android/send.java"};
	run(new DealJavaOJMutantClass(),args);
//	main2(null);
}
	        ...
	        if (cdecl.getName().equals(className))
	         {
	            ...
	            try 
	            {
	               ...
	               if (hasOperator(classOp, "PMD"))
	               {
	                  ...
	                  if(existIHD){
	                  mutant_op = new PMD( file_env, cdecl, compilationUnit );
	                  compilationUnit.accept(mutant_op);
	                  }
	               }
	               ...
	               if (hasOperator(classOp, "PPD"))
	               {
	                  ...
	                  if(existIHD){
	                  mutant_op = new PPD( file_env, cdecl, compilationUnit );
	                  compilationUnit.accept(mutant_op);
	                 }
	               }
	        ...
	        if (cdecl.getName().equals(className))
	         {
	    	    ...
	    	    DeclAnalyzer mutant_op=new DeclAnalyzer(file_env, null, cdecl,mutantPath,className);
