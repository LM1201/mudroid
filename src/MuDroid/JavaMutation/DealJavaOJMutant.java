...
public class DealJavaOJMutant extends DealJavaOJ{
	...
	{
		run(new DealJavaOJMutant(), new String[]{"F:/muAndroid/activity-lifecycle/src/com/example/android/lifecycle/ActivityA.java"});
	}
	...
	void genMutants(String mutantOp)throws Exception {
		...
		Mutator mutant_op ;
		Constructor<?> c=Class.forName(className).getConstructor(file_env.getClass(),ClassDeclaration.class,compilationUnit.getClass());
