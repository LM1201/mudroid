...
public class testReadProjectDirToXmlWithFilterOfMutant {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	new testReadProjectDirToXmlWithFilterOfMutant().main2(args);
...
//		pw.flush();
		...
		String javaarg0=args[0]+"/app/mutant/main";
		String xmlarg0=args[0]+"/app/mutant/main";
