...
public class choosexmlMutantJPanel extends JPanel 
				implements ActionListener,ItemListener
{
	...
	SummaryOfMutantPanel summaryp=new SummaryOfMutantPanel("F:/muandroid3/AndroidApp-master/app/mutant/main/.projectToXMLs/projectToXMLs_xml.xml");
	SummaryOfMutantPanel choosep=new SummaryOfMutantPanel(1);
...
//		listPanel.add(j);
	...
	private void getTable() {
		...
		// TODO Auto-generated method stub
		  ...
		  String[] args=new String[]{"F:/muandroid3/AndroidApp-master/app/mutant/main/.projectToXMLs/projectToXMLs_xml.xml","DBHelper.java","all","classOp","all"};
			try {
				gsm.run( args);
			} catch (Exception e) {
	...
	public static void main(String[] args)
	{
		...
		choosexmlMutantJPanel fjp=new choosexmlMutantJPanel();
		jf.add(fjp);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.showChoosedMutant)
		{
			...
			SummaryOfMutantPanel choosep=new SummaryOfMutantPanel("F:/muandroid3/AndroidApp-master/app/mutant/main/.projectToXMLs/projectToXMLs_xml.xml",nameSet,opTypeSet,cmopSet,tmopSet,emopSet,amopSet,xmopSet);
