...
public class DeleteDir {
    ...
    {
    	System.out.println(Project.getInstance().getmanifestMutPath());
    ...
    {
    	System.out.println(Project.getInstance().getJavaMutPath());
    ...
    {
    	System.out.println(Project.getInstance().getXmlMutPath());
